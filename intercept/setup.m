...
% Defenders
d1 = struct('x',[0],'y',[0],'R',5,'S',.8,'V',10,'a',[],'vdhat',[],'t_int',[],'t_reach',[],'ca',.1);
d2 = struct('x',[0],'y',[0],'R',5,'S',.8,'V',12,'a',[],'vdhat',[],'t_int',[],'t_reach',[],'ca',.1);
d3 = struct('x',[0],'y',[0],'R',5,'S',.8,'V',14,'a',[],'vdhat',[],'t_int',[],'t_reach',[],'ca',.25);
d = [d1,d2,d3];
