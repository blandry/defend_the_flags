...
d4 = struct('x',[0],'y',[0],'R',5,'S',.8,'V',10,'a',0,'vdhat',[],'t_int',[],'t_reach',[],'ca',.1);
d = [d1,d2,d3,d4];
...
a4 = struct('x',[],'y',[],'S',.8,'V',10,'t',[],'vahat',[],'active',1,'t_destroy',[]);
a5 = struct('x',[],'y',[],'S',.6,'V',10,'t',[],'vahat',[],'active',1,'t_destroy',[]);
a = [a1,a2,a3,a4,a5];
